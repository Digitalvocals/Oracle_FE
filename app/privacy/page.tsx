  ...
  return (
    <main className="min-h-screen bg-bg-primary p-4 md:p-8">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-text-tertiary mb-4">Last updated: December 6, 2025</p>
        ...
        <div className="space-y-6 text-text-secondary">
          ...
          <section className="bg-bg-elevated border border-bg-hover rounded-lg p-6">
            ...
            <p className="mb-2"><strong className="text-brand-primary">We do not collect personal information.</strong> StreamScout does not require:</p>
          ...
          <section className="bg-bg-elevated border border-bg-hover rounded-lg p-6">
            <h2 className="text-xl font-semibold text-text-primary mb-2">Automatically Collected Information</h2>
          ...
          <section className="bg-bg-elevated border border-bg-hover rounded-lg p-6">
            <h2 className="text-xl font-semibold text-text-primary mb-2">Third-Party Services</h2>
            <p className="mb-2">We use the following third-party services:</p>
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li><strong className="text-brand-primary">Google Analytics</strong> - Website traffic analysis</li>
              <li><strong className="text-brand-primary">Google AdSense</strong> - Advertising</li>
              <li><strong className="text-brand-primary">Twitch API</strong> - Game and streaming data</li>
            </ul>
            <p className="mt-2">
          ...
          <section className="bg-bg-elevated border border-bg-hover rounded-lg p-6">
            <h2 className="text-xl font-semibold text-text-primary mb-2">Data Storage</h2>
            <p>
          ...
          <section className="bg-bg-elevated border border-bg-hover rounded-lg p-6">
            <h2 className="text-xl font-semibold text-text-primary mb-2">Children's Privacy</h2>
            <p>
          ...
          <section className="bg-bg-elevated border border-bg-hover rounded-lg p-6">
            <h2 className="text-xl font-semibold text-text-primary mb-2">Contact Us</h2>
            <p>
              If you have questions about this Privacy Policy, please contact us at:{' '}
              <a href="mailto:privacy@streamscout.gg" className="text-brand-primary hover:underline">
